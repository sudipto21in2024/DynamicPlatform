...
builder.Services.AddScoped<CustomObjectGenerator>();
builder.Services.AddScoped<EnumGenerator>();
builder.Services.AddScoped<FormGenerator>();
builder.Services.AddScoped<ILanguageGenerator, DotNetGenerator>();
builder.Services.AddScoped<ILanguageGenerator, JavaSpringGenerator>();
builder.Services.AddScoped<ILanguageGenerator, PythonFastApiGenerator>();
builder.Services.AddScoped<ILanguageGenerator, NodeNestGenerator>();
builder.Services.AddScoped<LanguageGeneratorFactory>();
